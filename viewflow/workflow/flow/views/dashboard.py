...
class DashboardView(mixins.ProcessViewTemplateNames, generic.TemplateView):
...
class DashboardProcessListView(
    ...
    def process_id(self, process):
        process_url = self.request.resolver_match.flow_viewset.reverse('process_detail', args=[process.pk])

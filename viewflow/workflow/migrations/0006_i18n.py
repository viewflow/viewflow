...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name="process",
            name="flow_class",
            field=viewflow.workflow.fields.FlowReferenceField(
                max_length=250, verbose_name="Flow"
            ),
        ),
        migrations.AlterField(
            model_name="process",
        ...
        migrations.AlterField(
            model_name="task",
            name="flow_task",
            field=viewflow.workflow.fields.TaskReferenceField(
        ...
        migrations.AlterField(
            ...
            field=models.CharField(
                blank=True, null=True, max_length=255, verbose_name="Permission"
            ),
        ),
        migrations.AlterField(
            model_name="task",
            ...
            field=models.ManyToManyField(
                related_name="leading", to="viewflow.Task", verbose_name="Previous"
            ),
        ),
        migrations.AlterField(
            model_name="task",
            name="process",
            field=models.ForeignKey(
                to="viewflow.Process", verbose_name="Process", on_delete=models.CASCADE
            ),
        ),
        migrations.AlterField(
            model_name="task",
        ...
        migrations.AlterField(
            ...
            name="status",
            field=models.CharField(
                default="NEW", db_index=True, max_length=50, verbose_name="Status"
            ),
        ),
        migrations.AlterField(
            model_name="task",
            name="token",
            field=viewflow.workflow.fields.TokenField(
                default=viewflow.workflow.token.Token("start"),
                max_length=150,
                verbose_name="Token",
            ),
        ),

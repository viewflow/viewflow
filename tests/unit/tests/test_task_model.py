...
class Test(TestCase):
    def test_get_real_process(self):
        ...
        self.assertTrue(isinstance(task.get_process(), FunctionFlow.process_cls))
    ...
    def test_get_real_process_nohop(self):
        ...
        self.assertTrue(isinstance(task.get_process(), DefaultProcessFunctionFlow.process_cls))

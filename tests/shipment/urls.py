...
urlpatterns = patterns('shipment.views',
    url(r'shipment_type/(?P<act_id>\d+)/$', 'shipment_type', {'flow_task': ShipmentFlow.shipment_type}),
    ...
    url(r'take_extra_insurance/(?P<act_id>\d+)/$', 'take_extra_insurance', {'flow_task': ShipmentFlow.take_extra_insurance}),
